...
public class SkillController {
	...
	public ResponseEntity<SkillEntity> updateSkillStatus(@RequestParam Integer skillId, @RequestParam Byte status)
			throws RecordNotFoundException {
		try {
			SkillEntity entity = skillService.updateStatusBySkillId(skillId, status);
			return new ResponseEntity<SkillEntity>(entity, HttpStatus.OK);
		} catch (IllegalArgumentException e) {
			throw new RecordNotFoundException("No record found with this skillId :" + skillId);
		}
	}
}
