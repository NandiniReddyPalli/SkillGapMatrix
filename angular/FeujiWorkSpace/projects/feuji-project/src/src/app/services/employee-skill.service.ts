...
saveSkillCategoryAdmin(newCategory: SkillCategoryBean): Observable<SkillCategoryBean> {
  const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
  return this.http.post<SkillCategoryBean>('http://13.48.82.196:8081/api/referencedetails/save', newCategory, { headers });
}

saveSubSkillCategoryAdmin(newSubCategory: SubSkillCategoryBean): Observable<SubSkillCategoryBean> {
  const headers = new HttpHeaders({ 'Content-Type': 'application/json' });
  return this.http.post<SubSkillCategoryBean>('http://13.48.82.196:8081/api/referencedetails/addSubSkill', newSubCategory, { headers });
}
...
public getSkillCategoryNames():Observable<any[]>
{
  ...
  return this.http.get<any[]>(`http://13.48.82.196:8081/api/referencedetails/getref/Skill Category`)
}
